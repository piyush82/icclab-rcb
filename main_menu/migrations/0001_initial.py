...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tenants'
        db.create_table(u'main_menu_tenants', (
        ...
        db.send_create_signal(u'main_menu', ['Tenants'])
        ...
        db.create_table(u'main_menu_stackuser', (
            ...
            ('tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main_menu.Tenants'])),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Tenants'
        db.delete_table(u'main_menu_tenants')
    ...
    models = {
        ...
        u'main_menu.pricedaily': {
            ...
            'tenant_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main_menu.Tenants']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
