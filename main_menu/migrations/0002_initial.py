...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tenant'
        db.create_table(u'main_menu_tenant', (
        ...
        db.send_create_signal(u'main_menu', ['Tenant'])
        ...
        db.create_table(u'main_menu_stackuser', (
            ...
            ('tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main_menu.Tenant'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'main_menu_tenant')
    ...
    models = {
        ...
        u'main_menu.pricedaily': {
            ...
            'tenant_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main_menu.Tenant']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
