...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MetersCounter.meter_id'
        db.delete_column(u'main_menu_meterscounter', 'meter_id')

        # Deleting field 'MetersCounter.tenant_id'
        db.delete_column(u'main_menu_meterscounter', 'tenant_id_id')

        # Deleting field 'MetersCounter.resource_id'
        db.delete_column(u'main_menu_meterscounter', 'resource_id')


    def backwards(self, orm):
        # Adding field 'MetersCounter.meter_id'
        db.add_column(u'main_menu_meterscounter', 'meter_id',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'MetersCounter.tenant_id'
        db.add_column(u'main_menu_meterscounter', 'tenant_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['main_menu.StackUser']),
                      keep_default=False)

        # Adding field 'MetersCounter.resource_id'
        db.add_column(u'main_menu_meterscounter', 'resource_id',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)
